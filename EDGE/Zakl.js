...
document.querySelector('#pinfo').onclick=e=> {
     GM_op('https://raw.githubusercontent.com/gg54kjh/myFilesss/refs/heads/main/EDGE/Iz-zakladok.txt', 'pinfo')
}
document.querySelector('#as').onclick=e=> {
    GM_op('https://raw.githubusercontent.com/gg54kjh/myFilesss/refs/heads/main/EDGE/Iz-zakladok-2.txt', 'as')  
}
document.querySelector('#rchild').onclick=e=> {
    GM_op('https://raw.githubusercontent.com/gg54kjh/myFilesss/refs/heads/main/EDGE/Iz-zakladok-2.txt', 'remchildren')
}

document.querySelector('#vs').onclick=e=> {
    GM_op('https://raw.githubusercontent.com/gg54kjh/myFilesss/refs/heads/main/EDGE/Iz-zakladok.txt', 'vs')
}
document.querySelector('#vi').onclick=e=> {
    GM_op('https://raw.githubusercontent.com/gg54kjh/myFilesss/refs/heads/main/EDGE/Iz-zakladok.txt', 'vi')
}
  ...
  onload: function(response) {
    ...
    if (x==2) {
     ...
     if (x==3) {
      ...
      if (x=='pinfo') {
          ip = ip.match(/javascript:(if\(typeof jQuery!="undefined[\S\s]*?statswin.document.close\(\))/);
          eval(ip[1]) 
      }
      if (x=='as') {
